...
import cn.ff.dionysus.common.security.exception.ServerErrorException;
import cn.ff.dionysus.common.security.exception.UnauthorizedException;
...
public class DefaultWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
    ...
    private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
        ...
        return new ResponseEntity<>(new DefaultAuthException(e.getMessage(), -2, e.getOAuth2ErrorCode()), headers,
