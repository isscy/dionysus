...
public class WebUtil {
    ...
    public static void writeJson(HttpServletResponse response, Object object) {
        writeJson(response, JSON.toJSONString(object), MediaType.APPLICATION_JSON_UTF8_VALUE, HttpStatus.OK.value());
    }

    public static void writeJson(HttpServletResponse response, Object object, int httpCode) {
        writeJson(response, JSON.toJSONString(object), MediaType.APPLICATION_JSON_UTF8_VALUE, httpCode);
    }
