...
import cn.ff.dionysus.common.basal.entity.SysRole;
...
public interface SysUserMapper extends BaseMapper<SysUser> {
     ...
     * 获取用户的列表
     */
    Page<SysUser> getList(Page<SysUser> page, @Param("status") String status,@Param("search") String search);
     ...
     * 获取一个用户的所有角色
     */
    List<SysRole> getOneUserAllRoles(Integer userId);
