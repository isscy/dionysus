...
import cn.ff.dionysus.common.basal.exception.BaseException;
...
public class OpenExceptionHandler {
    ...
    public static R bindException(Exception e) {
        ...
        return Rs.fail(ResultEnum.CLIENT_PARAM_405.getCode(), msg, null, "[用户请求异常]");
    }
    ...
    public static R openException(Exception ex, HttpServletRequest request, HttpServletResponse response) {
        ...
        r.setEXT(((BaseException) ex).getEXT());
        return r;
    }
